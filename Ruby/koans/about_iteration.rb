...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Ele faz a operação que está no bloco para todos os elementos do vetor,
    # guardando em uma variavel o resultado e usando na conta seguinte o valor
    # acumulado.
    # Obs : o valor que é passado como parametro para o inject é o valor que
    # a variavel acumulada começará
  end
